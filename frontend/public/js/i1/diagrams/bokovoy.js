...
function diagramBokovoyPhoto(g, heightVal, plankTVal, edgeVal, boardLenVal){
  ...
  // Стрелка у выступающего верхнего левого угла первой планки - показывает
  // толщину доски крышки + толщину планки крышки (plankTVal, по уточнению
  // пользователя - именно это физически видно в этом месте на фото, не
  // толщина самой планки бокового щита); идёт сверху, в той же зоне, что и
  // стрелка длины доски (а не слева от кадра, как раньше) - иначе под неё
  // резервируется большой отступ слева, и весь чертёж визуально уезжает
  // вправо от заголовка секции.
