...
async function calculateNow(){
  ...
  // labelScale (см. renderDiagram() в js/common-diagrams.js): фиксированный
  ...
  // остальных чертежах.
  // Щит торцевой и боковой - каждый своего максимального размера в слоте
  // (по указанию пользователя, без общего масштаба пары; см.
  // growDiagramToSlot в common-print.js).
  let tablesHtml = '';
