...
function computeGost10198I3(input) {
  ...
  // Число "этажей" щита торцевого/бокового: до 2000мм включительно наружной
  // высоты - 1 этаж, свыше 2000мм - 2 этажа (средняя горизонтальная планка
  // делит щит пополам). Верхнего предела по высоте нет (искусственный
  // потолок в 4000мм убран по уточнению пользователя) - свыше 2000мм расчёт
